...
--
--   b) Un número activo SÍ recibe horario (749608 = Ángel):
--        SELECT horario_equipo('1217','749608') IS NOT NULL;   -- espera true
--
...
--        SELECT horario_equipo('1217','749608')->'equipo'->'pin';  -- espera NULL
--
