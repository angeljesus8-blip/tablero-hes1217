...
--         '1217', (select gas_token from public.tiendas where store_id='1217'), '749608');
--     Tiene que dar 23 o mas (las de la lista vieja estan de baja y tambien salen).
--
--  2) Que el asesor NO puede. Con el numero de Arturo (747851) tiene que dar
--     cero filas, no la lista:
--       select count(*) from public.accesorios_catalogo_admin(
--         '1217', (select gas_token from public.tiendas where store_id='1217'), '747851');
--
...
--         'PRUEBA BORRAR', 111, 999, NULL, '43739-PRUEBA', '43739', '749608');
