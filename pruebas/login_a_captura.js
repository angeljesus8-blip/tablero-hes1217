...
const RESPUESTA_ASESOR = [{
  ...
  vendedores: ['Arnulfo Gonzalez Arrieta', 'Miguel Angel Garcia Gutierrez',
               'Laura Bonilla Galan', 'Arturo Aguilar rosette', 'Angel de jesus Perea arias'],
  emp_no: '747854', emp_nombre: 'Arnulfo González Arrieta',
  emp_puesto: 'Asesor de Tienda', emp_admin: false,
  gas_token: 'xxxx', hoja_auth: 'Laura Bonilla Galan', sheet_url: 'https://docs.google.com/x',
}];
...
if(!err){
  ...
  ok('y con el nombre del asesor puesto', el('vendLabel').textContent === 'Arnulfo Gonzalez Arrieta',
