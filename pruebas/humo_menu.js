...
const EQUIPO = ['Arnulfo González Arrieta', 'Miguel Ángel García Gutiérrez',
                'Laura Bonilla Galán', 'Arturo Aguilar Rosete', 'Ángel de Jesús Perea Arias'];
const conLista = { store_id:'1217', vendedores:EQUIPO };
const sinLista = { store_id:'1217', vendedores:[] };
const EMP = JSON.stringify({ empno:'747854', nombre:'Arnulfo González Arrieta' });
